...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestInfo.prototype.drawQuestSteps = function(q) {
        ...
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText("Pasos", 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
    ...
    Window_QuestInfo.prototype.drawQuestRewards = function(q) {
        ...
        // Draw Rewards
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText("Recompensas", 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
